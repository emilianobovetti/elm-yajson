...
ofString lst =
    Yajson.Object (List.map (Tuple.mapSecond Yajson.String) lst)
...
ofFloat lst =
    Yajson.Object (List.map (Tuple.mapSecond Yajson.Number) lst)
...
ofInt lst =
    Yajson.Object (List.map (Tuple.mapSecond (toFloat >> Yajson.Number)) lst)
...
ofBool lst =
    Yajson.Object (List.map (Tuple.mapSecond Yajson.Bool) lst)
